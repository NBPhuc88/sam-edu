    ...
    public function run(): void
    {
        ...
        $seoEntries = [
            [
                ...
                'keywords'      => 'Giải Pháp Quản Lý Giáo Dục, phần mềm quản lý trung tâm, quản lý học sinh, điểm danh thông minh, SAM Digital, ZaloPay QR Code, quản lý đào tạo 2026',
            ...
            [
                ...
                'description'   => 'Bảng giá dịch vụ phần mềm quản lý giáo dục minh bạch. Trải nghiệm 30 ngày dùng thử miễn phí, gói hàng tháng linh hoạt và gói năm tiết kiệm 20% tự động gia hạn qua ZaloPay.',
                'keywords'      => 'gói cước phần mềm giáo dục, bảng giá phần mềm quản lý trung tâm, dùng thử 30 ngày miễn phí, thanh toán ZaloPay QR, đăng ký gói SAM Digital',
