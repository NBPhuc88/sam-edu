...
| **11** | `classes`                 | Quản lý Lớp học (`center_id`, `teacher_id`, `subject_id`, `room_id`, `name`, `code`, `max_capacity`, `start_date`, `end_date`, `status`). Model: `App\Models\SchoolClass`.                                |
| **12** | `class_students`          | Danh sách học sinh ghi danh trong lớp học (`class_id`, `student_id`, `joined_at`, `status`).                                                                                                              |
| **13** | `class_subjects`          | Liên kết môn học phụ / bổ trợ trong lớp học.                                                                                                                                                              |
