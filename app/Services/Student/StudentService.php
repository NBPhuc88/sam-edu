...
class StudentService implements StudentServiceInterface
{
    ...
    public function createStudent(array $data, ?Admin $admin = null): Student
    {
        ...
        if (empty($studentCode)) {
            ...
            $studentCode = Constant::PREFIX_STUDENT . str_pad((string) $count, Constant::CODE_PAD_LENGTH, Constant::CODE_PAD_CHAR, STR_PAD_LEFT);
    ...
    public function getStudentDetailData(
        ...
        if (! $student) {
            throw new NotFoundHttpException('Học sinh không tồn tại hoặc bạn không có quyền truy cập.');
        }

        $student->loadMissing('center:id,name,code');
