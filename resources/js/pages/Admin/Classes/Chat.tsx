...
export default function ClassChatPage({
    ...
    const getSenderBadge = (type: string) => {
        switch (type) {
            case 'admin':
                return (
                    <span className="inline-flex items-center gap-1 rounded border border-emerald-200 bg-emerald-100 px-2 py-0.5 text-xs font-semibold text-emerald-800">
            ...
            case 'teacher':
                return (
                    <span className="inline-flex items-center gap-1 rounded border border-blue-200 bg-blue-100 px-2 py-0.5 text-xs font-semibold text-blue-800">
            ...
            default:
                return (
                    <span className="inline-flex items-center gap-1 rounded border border-slate-200 bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-700">
                ...
                <Card className="flex h-[750px] flex-col overflow-hidden">
                    ...
                    <div className="flex items-center justify-between border-b border-slate-800 bg-slate-900 p-5 text-white">
                        <div className="flex items-center gap-3">
                            <div className="flex h-11 w-11 items-center justify-center rounded-full bg-emerald-600 font-bold text-white shadow-sm">
                    ...
                    {pinnedMessage && (
                        <div className="animate-fadeIn flex items-center justify-between gap-3 border-b border-amber-200 bg-amber-50 p-3.5 text-amber-900">
                            <div className="flex min-w-0 items-start gap-2.5">
                                <Pin className="mt-0.5 h-4.5 w-4.5 shrink-0 fill-amber-500 text-amber-600" />
                        ...
                        {messages.length === 0 ? (
                            ...
                            messages.map((msg) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Avatar */}
                                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-slate-300 bg-slate-200 text-sm font-bold text-slate-700">
                                            {msg.sender_name
                                                .charAt(0)
                                                .toUpperCase()}
                                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="group relative flex items-center gap-2">
                                                <div
                                                    className={`rounded-2xl p-3.5 text-sm leading-relaxed shadow-xs ${
                                                        isSelf
                                                ...
                                                {currentUser.can_pin && (
                                                    ...
                                                    >
                                                        <Pin
                                                            className={`h-4 w-4 ${msg.is_pinned ? 'fill-amber-500' : ''}`}
                                                        />
                                                    </button>
                                                )}
                                            </div>
